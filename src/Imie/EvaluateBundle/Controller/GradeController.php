...
use Imie\EvaluateBundle\Form\GradeType;
...
class GradeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ImieEvaluateBundle:Grade')->findAll();
     ...
     * @Method("POST")
     * @Template("ImieEvaluateBundle:Grade:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImieEvaluateBundle:Grade')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ImieEvaluateBundle:Grade:edit.html.twig")
     */
