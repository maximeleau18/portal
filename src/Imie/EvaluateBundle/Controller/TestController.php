...
use Imie\EvaluateBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ImieEvaluateBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("ImieEvaluateBundle:Test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImieEvaluateBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ImieEvaluateBundle:Test:edit.html.twig")
     */
